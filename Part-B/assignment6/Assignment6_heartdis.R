# Roll no. 33235
# Batch: L10
# P.S.: Application of Linear regression and Naivy Baise on Heart disease dataset to predict the fate (prob. of heart disease)
...
hdata <- read.csv(file.choose(),header=TRUE,sep=",")
names(hdata)
str(hdata)
dim(hdata)
